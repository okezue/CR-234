...
At simulator revision `5747132`, the 1,927-game benchmark has 62.9% winner agreement, 40.8% exact crown scores, 47.4% premature endings, and 0.2107 mean normalized final tower HP error. Re-running `824f1eb` with the same corrected evaluator gives 62.1%, 39.9%, 49.1%, and 0.2174 respectively. The fresh 225-game standard-mode sample is mixed: winner agreement falls from 69.8% to 69.3%, while HP error improves from 0.2221 to 0.2169. These results establish remaining discrepancies, not completion of the 100% fidelity goal.
