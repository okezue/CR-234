...
K={'sight_slack':0.0,'tower_acq':0.0,'tower_first':0.0,'load_carry':1.0,'sep_strength':1.0,'sep_iters':1,'bridge_blend':0.0,'splash_hitbox':1.0,
   'kb_scale':1.0,'death_stagger':0.0,'detour_look':99.0,'charge_scale':1.0,'kite_drop':0,'kite_slack':0.0}
B={'sight_slack':(-1.5,2.0),'tower_acq':(0.0,0.8),'tower_first':(0.0,0.8),'load_carry':(0.0,1.0),'sep_strength':(0.0,1.0),'sep_iters':(1,3),
