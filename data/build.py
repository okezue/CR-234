    ...
    out["meta"] = {
        ...
        "legacySkills": {
            ...
            "params": "charge.range, dash.chargeTime (wind-up of a dash or jump)/radius/speed/count/towerDamage, spawnOnDeath.count/hpPercent, "
                      ...
                      "heal.radius/overHeal/perKillTiers, shield.damage/radius/pushbackDistance (blast when the shield breaks), poison.stackHits, "
                      "snipe.minRange/maxRange/cooldown/towerDamagePercent, "
